export function getDomRefs() {
  ...
  return {
    ...
    faviconSourceOptions: document.getElementById('favicon-source-options'),
    faviconSourceInputs: Array.from(document.querySelectorAll('input[name="favicon-source"]')),
    faviconPreviewGoogle: document.getElementById('favicon-preview-google'),
    faviconPreviewChrome: document.getElementById('favicon-preview-chrome'),
    ...
    grantFaviconPermsBtn: document.getElementById('grant-favicon-perms'),
    faviconPermHint: document.getElementById('favicon-perm-hint'),
    ...
    syncProfileSelect: {
      get value() {
        return getRadioVal('sync-profile');
      },
      set value(val) {
        setRadioVal('sync-profile', val);
      },
      addEventListener(event, cb) {
        addRadioListener('sync-profile', event, cb);
      }
    },
