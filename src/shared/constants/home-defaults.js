...
export const DEFAULT_LINKS = [
  { _id: 'linksirdilh', order: 0, parent: 'A', title: 'Alpha123', url: 'https://alpha123.uk/' },
  {
    ...
    parent: 'A',
    title: 'Phần mềm',
    url: 'https://voz.vn/f/phan-mem.13/'
  },
  {
    _id: 'linksiaildg',
    order: 2,
  ...
  },
  {
    ...
    parent: 'A',
    title: 'Tiền điện tử',
    url: 'https://voz.vn/f/tien-dien-tu.94/'
  },
...

  {
    ...
    parent: 'C',
    title: 'CME Đăng ký',
    url: 'https://cme.bvhungvuong.vn/course/DangKyDT'
  },
  {
    _id: 'linksomcfqn',
    order: 1,
    parent: 'C',
    title: 'Chỉ đạo tuyến',
    url: 'http://choray.vn/ttchidaotuyen/Default.aspx?tabid=277&language=vi-VN'
  },
  {
    _id: 'linkshqrpig',
    order: 2,
    parent: 'C',
    title: 'CME Courses',
    url: 'https://cme.bvhungvuong.vn/Course/Index'
  },
  {
    _id: 'linksodedll',
    order: 3,
    parent: 'C',
    title: 'CTUMP',
    url: 'https://htql.ctump.edu.vn/ctump/dichvucong/ttdv/'
  },
  {
    _id: 'linksdgaggl',
    order: 4,
    parent: 'C',
    title: 'Dịch vụ công',
    url: 'https://dichvucong.gov.vn/p/home/dvc-dich-vu-cong-cua-toi.html'
  },
  {
    _id: 'linksqbpgdd',
    order: 5,
  ...
  { _id: 'linksegljrm', order: 0, parent: 'D', title: 'TheFetus', url: 'https://thefetus.net/' },
  {
    ...
    parent: 'D',
    title: 'RIS',
    url: 'http://113.161.160.233/ris/study/reading'
  },
  {
    _id: 'linkshhlpmc',
    order: 2,
    parent: 'D',
    title: 'Radiology Asst',
  ...
  },
  {
    ...
    parent: 'D',
    title: 'Radiopaedia',
    url: 'https://radiopaedia.org/search?page=1&scope=articles&section=Classifications&sort=date_of_last_edit&system=Gynaecology'
  },
  {
    _id: 'linksnbakpc',
    order: 4,
    parent: 'D',
    title: 'Radiopaedia User',
    url: 'https://radiopaedia.org/users/maulikspatel'
  },
  {
    _id: 'linksnpjmgk',
    order: 5,
    parent: 'D',
    title: 'PACS HMU',
    url: 'https://pacs.benhviendaihocyhanoi.com/ris/study/reading#listStudy'
  },
  {
    _id: 'linkslnjldf',
    order: 6,
    parent: 'D',
    title: 'YDS',
    url: 'https://pacs.umc.edu.vn/portal/'
  },
  { _id: 'linksrfmmka', order: 7, parent: 'D', title: 'CR', url: 'https://bvcr.ddns.net/portal/' },
  {
    ...
    parent: 'D',
    title: 'Ultrasound',
    url: 'https://www.ultrasoundcases.info/cases'
  },
  ...
  },
  {
    ...
    parent: 'E',
    title: 'Notion',
    url: 'https://www.notion.so/23ee294244cd4904ace8a548a8ffd74e'
  },
  {
    _id: 'linkslaabcd',
    order: 18,
